...
exports.generateClassesFromTextFile = void 0;
var fs = require('fs');
/**
 ...
 */
function generateClassesFromTextFile(inputFilePath, outputDirPath) {
    // 入力ファイルの読み込み
...
exports.generateClassesFromTextFile = generateClassesFromTextFile;
